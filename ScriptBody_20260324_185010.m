...
simStruct = struct('ModelVars', struct('Common', struct('Control', struct('Targets', struct('Vout', 0, 'Pout', 0)), 'Load', struct('Front', struct('R_L', 0)), 'ToFile', struct('FileNameStandalone', ''), 'Thermal', struct('Twater', 0)), 'DCDC_Rail1', struct('Control', struct('Inputs', struct('Iin', 0, 'Vin', 0, 'Vout', 0, 'Pout', 0)))), 'SolverOpts', struct());
