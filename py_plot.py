...
#*-------------------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    def graph_scopes(self,fileLog,simutil,standalone_exist=False):
        ...
        if standalone_exist:
            ...
            if (not dp.JSON["perturbation"]==0) and (dp.JSON["nvars"]==None): # for sensitivity case with nominals
                mat_names           = ["Standalone_RMS","Standalone_AVG","Standalone_MAX","Standalone_MIN",
                                       "Standalone_RMS_Sens","Standalone_AVG_Sens","Standalone_MAX_Sens","Standalone_MIN_Sens","Standalone_FFT","Standalone_FFT_Sens"]
            ...
            # FFT matrix
            if (not dp.JSON["perturbation"]==0) and (dp.JSON["nvars"]==None): # for sensitivity case with nominals
                combined_fft_matrix = dp.np.hstack((standalone_matrices.get('FFT'), standalone_matrices.get('FFT_Sens')))
            else: # no sensitivity
