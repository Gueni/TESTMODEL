...
def load_config_and_data():
    ...
    mat_names = ["Peak_Currents", "RMS_Currents", "AVG_Currents", "Peak_Voltages", "RMS_Voltages", 
                 "AVG_Voltages", "FFT_Current", "FFT_Voltage", "Dissipations", "Elec_Stats", 
                 "Temps", "Thermal_Stats"]
...
@app.callback(
    ...
    Input('main-plot', 'clickData'),  # Now using the Graph component's clickData
