...
ToFile				=	dp.OrderedDict({																													#*	PLECS built-in data output configuration
                            ...
                            'FileNameStandalone'	:			  ''																					,	#?	name of the custom exported data file
...
RboxConfigs			=	{																																	#*	Rbox components configuartions
                            ...
                            'DCplus'      		  	: 5                         																		,	#?	1->Real-Inductive | 2->Ideal | 3->Real-Resistive | 4->Pass | 5->Short
							'DCminus'      		  	: 5                         																		,	#?	1->Real-Inductive | 2->Ideal | 3->Real-Resistive | 4->Pass | 5->Short
							'OBCplus'      		  	: 5                         																		,	#?	1->Real-Inductive | 2->Ideal | 3->Real-Resistive | 4->Pass | 5->Short
							'OBCminus'      		: 5                         																		,	#?	1->Real-Inductive | 2->Ideal | 3->Real-Resistive | 4->Pass | 5->Short
							...
							'PyroAux'      			: 5                         																		,	#?	1->Real-Inductive | 2->Ideal | 3->Real-Resistive | 4->Pass | 5->Short
...
Load 				=	{																																	#*	loading behavior
							'Front'		:	{																												#!	vehicle front load parameters
                                ...
                                'Rconfig'				: 2																								,	#?	variable resistance configuration, 1->voltage-source implementation | 2->current-source implementation
...
RCsnubber		=		{																																	#*	RC snubbers parameters
                        ...
                        'PS_MOSFET'	:	{																													#!	PS MOSFETs RC snubbers parameters
							'Config'				:	2																								,	#	1->Enable | 2->Disable
							'Rs'		:	{																												#	snubber resistors
								'R'					:	0																								,	#?	resistance value
								'nPar'				:	1																									#?	number of parallel resistors
                        ...
                        'SC_MOSFET'	:	{																													#!	SC MOSFETs RC snubbers parameters
							'Config'				:	2																								,	#	1->Enable | 2->Disable
							'Rs'		:	{																												#	snubber resistors
								'R'					:	0																								,	#?	resistance value
								'nPar'				:	1																									#?	number of parallel resistors
...
SC_Protection 		=	{																																	#*	internal short-circuit protection parameters
							'Switch'						:	dp.copy.deepcopy(Switches['NVMTS0D6N04C'])													,	#?	short-circuit switch parameters
                            'location'						:	0																							,	#?	switch location, 0->on positive path | 1->on negative path
                            'SlewRate'			:	{																										#!	fuse slew rate control parameteres
                                'Cdvdt'	:	{																												#	gate-GND capacitance parameters
                                    'Config'   				:	2																						,   #?	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
									'Csingle'  				:	10e-9																					,   #?	single capacitor value
									'Rsingle'  				:	10																						,   #?	ESR of single capacitor
									'Lsingle'  				:	0																						,   #?	ESL of single capacitor
									'nPar' 	  				:	1																						,   #?	number of parallel connections
									'nSer' 	  				:	1																						,   #?	number of series connections
									'Vinit'    				:	0																						,   #?	capacitor initial voltage
								},
                                'Cgd'		:	{																											#	external gate-drain capacitance parameters
                                    'Config'   				:	2																						,   #?	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
									'Csingle'  				:	200e-9																					,   #?	single capacitor value
									'Rsingle'  				:	0																						,   #?	ESR of single capacitor
									'Lsingle'  				:	0																						,   #?	ESL of single capacitor
									'nPar' 	  				:	1																						,   #?	number of parallel connections
									'nSer' 	  				:	1																						,   #?	number of series connections
                                ...
                                'Cgs'		:	{																											#	external gate-source capacitance parameters
                                ...
                                'Cds'		:	{																											#	external drain-source capacitance parameters
                                    'Config'   				:	5																						,   #?	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
									'Csingle'  				:	10e-9																					,   #?	single capacitor value
									'Rsingle'  				:	10																						,   #?	ESR of single capacitor
									'Lsingle'  				:	0																						,   #?	ESL of single capacitor
...
Busbars_PCB			=	{																																	#*	PCB traces and/or busbars resistances
                            ...
                            'LV_Bridge'		:	{																											#!	PCB trace resistances related to LV bridge
                                'LeftLeg'			:	0																								,	#	resistance between HS and LS of left leg
                                'RightLeg'			:	0																								,	#	resistance between HS and LS of right leg
								'Drain'	:	{																												#!	PCB resistance in series to half-bridge drain
                                    'RL'			:	0																								,	#?	right leg drain PCB resistance
                                    'LL'			:	0																									#?	left leg drain PCB resistance
								},
                                'Source':	{																												#!	PCB resistance in series to half-bridge source
                                    'RL'			:	0																								,	#?	right leg drain PCB resistance
                                    'LL'			:	0																									#?	left leg drain PCB resistance
								}
							},
                            'HV_Bridge'		:	{																											#!	PCB trace resistances related to HV bridge
                                'LeftLeg'			:	0																								,	#	resistance between HS and LS of left leg
                                'RightLeg'			:	0																								,	#	resistance between HS and LS of right leg
								'Drain'	:	{																												#!	PCB resistance in series to half-bridge drain
                                    'RL'			:	0																								,	#?	right leg drain PCB resistance
...
LVS					=	{																																	#*	LV battery parameters
                            ...
                            'L'						:	0																								,	#?	equivalen battery series inductance
                            ...
                            'Cell'	:	{																													#!	battery cell parameters
								'Model'				:	dp.copy.deepcopy(Battery['CAMEL_230906_warm_BOL'])												,	#?	cell electrical parameters
                                'Ts'				:	-1																								,	#?	sample time of cell model spliting, 0 for no delay, -1 for inherited
...
HVS					= 	{																																	#*	LV Bordnetz parameters
							'Config'        		: 	2               																				,   #? 	1->complex | 2>-simple | 3->disable
							'Rcell'         		:	3.3e-3			  		 																		,   #? 	single-cell resistance
							'Lcell'         		:	80e-9*0																							,   #? 	single-cell inductance
                            'Cell'	:	{																													#!	battery cell parameters
								'Model'				:	dp.copy.deepcopy(Battery['CAMEL_230906_warm_BOL'])												,	#?	cell electrical parameters
                                'Ts'				:	-1																								,	#?	sample time of cell model spliting, 0 for no delay, -1 for inherited
								'InitSoC'			:	1.0 																							,	#?	initial state of charge of cells
                                'RsConfig'			:	1																								,	#?	variable resistor config, 1->VS model | 2->IS Model
                                'nParallel'			:	5																								,	#?	number of parallel cells
                                'nSeries'			:	124																								,	#?	number of series cells
								'Temp'				:	25																									#?	initial battery temperature
							}
						}

Cdc 	=	{
    	'Cdc1'	:	{																																		#*	first vehicle DC link parameters
        					'Config'    			: 2				  																					,   #? 	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
    	...
    	'Cdc2'	:	{																																		#*	second vehicle DC link parameters
        					'Config'    			: 5				  																					,   #? 	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
							'Csingle'   			: 0				  																					,   #? 	Single Capacitor Size
							'Rsingle'   			: 0				  																					,   #? 	Single Capacitor ESR
							'Lsingle'   			: 0				  																					,   #?	Single Capacitor ESL
							'nPar' 	    			: 1				  																					,   #?	Parallel Branches
							'nSer' 	    			: 1				  																					,   #?	Series Branches
							'Vinit'     			: 0				  																					,   #?	Initial Voltage
							'Load'	:	{																													#!	load parameters
								...
								'Type'	   				: 4																								,	#?	1->ohmic load | 2->current load | 3->power load | 4->pass
								'R_L'       			: 0																								,	#?	resistive-load model
								'I_L'       			: 0																								,	#?	current-load model
                            	'L_L'					: 0																								,	#?	inductive load model
                                'Vvec'					: [0,1]																							,	#?	power load voltage vector
								'Rvec'      			: [0,0]																							,	#?	resistive-load vector
								'Ivec'     				: [0,0]																							,	#?	current-load vector
                                'Pload'					: 0																								,	#?	constant power load
								'OutLen'				: [1,1]																							,	#?	number of repetition of each load point
								'slpPos'				: 0																								,	#?	positive current change slope
								'slpNeg'				: 0																								,	#?	negative current change slope
                                'Td'					: 0																								,	#?	load time delay
    	...
    	'Cdc3'	:	{																																		#*	secthirdond vehicle DC link parameters
        					'Config'    			: 5				  																					,   #? 	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
							'Csingle'   			: 0				  																					,   #? 	Single Capacitor Size
							'Rsingle'   			: 0				  																					,   #? 	Single Capacitor ESR
							'Lsingle'   			: 0				  																					,   #?	Single Capacitor ESL
    	...
    	'Cdc4'	:	{																																		#*	fourth vehicle DC link parameters
        					'Config'    			: 5				  																					,   #? 	1->capacitor only | 2->include ESR | 3->include ESR & ESL | 4->variable capacitor
							'Csingle'   			: 0				  																					,   #? 	Single Capacitor Size
							'Rsingle'   			: 0				  																					,   #? 	Single Capacitor ESR
							'Lsingle'   			: 0				  																					,   #?	Single Capacitor ESL
...
DCDC_Rail2 			= 	dp.copy.deepcopy(DCDC_Rail1)
